...
@Component({
    selector: 'app-grandexchange-item-detail',
    templateUrl: 'grandexchange-item-detail.component.html',
    styleUrls: ['grandexchange-item-detail.component.css'],
  })
export class GrandExchangeItemDetailComponent implements OnInit, OnDestroy {
    storeSubscription: Subscription;
       ...
       // ['#43E226', '#00C86D', '#00AA8F', '#008995']"
        ...
        xaxis = {
          ...
          labels: { //show y axis descriptions downside
            show: true,
            style: {
                colors: ['#FFFFFF'],
                fontSize: '18px',
          ...
          tooltip: { //tooltip on bottm of graph
            enabled: false         
          }
        }
      ...
      fill1 =  {
        ...
        gradient: {
          ...
          opacityFrom: 0.7,
          opacityTo: 0.9,
          colorStops: [ // offset from y 0 to y 100%. color range and opacity
            {
              offset: 0,
              color: "#FFFFFF",
              opacity: 0
      ...
      //der aktuelle punkt auf der linie wo man mit der maus ist
      markers = {
        size: 0, //show marker for each datapoint true / false, buggy
        colors: ['#43E226'],
        radius: 20, //size of a marker - buggy does not change
